...
export const siteContent: Record<Locale, SiteContent> = {
  es: {
    ...
    contact: {
      ...
      whatsappText: 'Hola Solwave, me interesa desarrollar un proyecto de software y me gustaría saber más.',
  ...
  en: {
    ...
    contact: {
      ...
      whatsappText: 'Hi Solwave, I am interested in building a software project and would like to learn more.',
      whatsappTitle: 'WhatsApp',
