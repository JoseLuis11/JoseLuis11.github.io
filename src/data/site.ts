...
export const siteContent: Record<Locale, SiteContent> = {
  es: {
    ...
    contact: {
      ...
      whatsappText: 'Hola Solwave, me interesa mejorar mi negocio con un sitio web, sistema o automatización. Me gustaría platicar sobre una posible solución.',
  ...
  en: {
    ...
    contact: {
      ...
      whatsappText: 'Hi Solwave, I am interested in improving my business with a website, custom system, or automation. I would like to talk about a possible solution.',
      whatsappTitle: 'WhatsApp',
